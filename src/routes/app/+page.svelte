...
<div class="h-screen w-screen bg-cover bg-center relative text-white overflow-hidden flex flex-col">
    ...
    <div class="container mx-auto px-3 sm:px-4 relative z-10 flex flex-col h-full">
        ...
        <main class="flex-grow pb-2 md:pb-4 overflow-hidden flex flex-col">
            ...
            <div class="sm:hidden flex mb-2 space-x-2">
                <button
            ...
            <!-- Desktop layout: grid -->
            <div class="hidden sm:grid sm:grid-cols-3 gap-4 md:gap-6 h-full">
                <!-- Calendar (left side) -->
